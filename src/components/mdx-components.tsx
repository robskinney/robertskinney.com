...
import { CodeBlock } from "./ui/shadcn-io/code-block";
import { MdxCodeblock } from "./mdx-codeblock";
import { MdxSnippet } from "./mdx-snippet";
...
const components = {
  ...
  img: ({
    ...
    <img
      className={cn(
        "rounded-md border mx-auto w-full md:w-2/3 xl:w-1/2",
        className
      )}
      alt={alt}
      {...props}
